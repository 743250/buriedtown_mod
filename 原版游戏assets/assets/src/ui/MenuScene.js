    ...
    onEnter: function () {
        ...
        if (cc.sys.os == cc.sys.OS_ANDROID) {
            ...
            if (PurchaseAndroid.payType !== PurchaseAndroid.PAY_TYPE_GOOGLE_PLAY) {
                ...
                var musicInfo = JSON.parse(jsb.reflection.callStaticMethod("net/dice7/pay/PayHelper", "getMusicInfo", "()Ljava/lang/String;"));
...
var DownloadConfirmLayer = DialogBig.extend({
    ctor: function (versionConfig) {
        ...
        // versionTitle.setColor(cc.color.BLACK);
        ...
        updateLabel.setColor(cc.color.BLACK);
...
var DownloadingLayer = DialogTiny.extend({
    ctor: function () {
        ...
        var versionConfig = versionStrConfigStr ? JSON.parse(update.getVersionString()) : null;
