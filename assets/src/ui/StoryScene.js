    ...
    onEnter: function () {
        ...
        bg.setClickListener(this, function () {
            ...
            try {
                ...
                bg._starting = false;
                bg.setEnabled(true);
                cc.e("start game failed: " + (e && e.stack ? e.stack : e));
                var errorMsg = e && e.message ? e.message : e;
                uiUtil.showTinyInfoDialog("开局初始化失败，请返回主菜单重试。\n" + errorMsg);
            }
        });
        bg.setEnabled(false);
        ...
        txt1.setColor(UITheme.colors.WHITE);
        ...
        txt2.setColor(UITheme.colors.WHITE);
        ...
        txt3.setColor(UITheme.colors.WHITE);
        ...
        txt4.setColor(UITheme.colors.WHITE);
        ...
        txt5.setColor(UITheme.colors.WHITE);
        ...
        txt6.setColor(UITheme.colors.WHITE);
        ...
        txt7.setColor(UITheme.colors.WHITE);
