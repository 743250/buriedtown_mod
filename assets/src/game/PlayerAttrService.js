...
var PlayerAttrService = {
    ...
    getTemperatureConfigBySeason: function (playerInstance, seasonIndex) {
        ...
        if (seasonIndex === undefined || seasonIndex === null) {
            seasonIndex = cc.timer && typeof cc.timer.getSeason === "function" ? cc.timer.getSeason() : 0;
        }
        seasonIndex = Number(seasonIndex) || 0;
        seasonIndex = ((seasonIndex % seasonConfigList.length) + seasonConfigList.length) % seasonConfigList.length;
        return seasonConfigList[seasonIndex];
    },
    ...
    getTemperatureHomeBonus: function (playerInstance) {
        if (!playerInstance || typeof playerInstance.isAtHome !== "function" || !playerInstance.isAtHome()) {
            return 0;
        }
