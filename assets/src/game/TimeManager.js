...
var TimerManager = cc.Class.extend({
    ...
    getTimeFromNowToNight: function () {
        var endTime = 0;
        var formatTime = this.formatTime();
        if (formatTime.h < this.stageTime[2]) {
            endTime = this.objToTime({
                d: formatTime.d,
                h: this.stageTime[2],
                m: 0,
